...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "localhost", uriPort = 443)
@WebMvcTest(BeerController.class)
@ComponentScan(basePackages = "br.com.prcompany.msscbeerservice.web.mappers")
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("beerStyle").description("Beer Style").type(BeerStyleEnum.class).attributes(),
